...
export const FALLBACK_ELIGIBLE_SHOPS: ShopItem[] = [
  // Dine (8)
  { id: 'shop-huang-tu-di', name: "Huang Tu Di Xi'An Delights", slug: 'huang-tu-di-xi-an-delights', category: 'Dine', level: 'L2', unit: '#02-08', is_eligible: true },
  ...
  { id: 'shop-yan-s-tomato', name: "Yan's Tomato Hot Pot", slug: 'yan-s-tomato-hot-pot', category: 'Dine', level: 'L2', unit: '#02-10', is_eligible: true },
  ...
  { id: 'shop-q-and-m-dental', name: 'Q & M Dental Surgery', slug: 'q-and-m-dental-surgery', category: 'Services', level: 'L2', unit: '#02-02', is_eligible: true },
